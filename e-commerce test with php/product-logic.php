           ...
           ?>
               ...
               <div class="each-products">
                   <div class="product-image-container">
                       <img src="admin/uploads/<?php echo $row['picture'] ?>" alt="<?php echo $row['p_name'] ?>" name="<?php echo $row['picture']; ?>">
                    </div>
  ...
  function categories_section(){
              ...
              if(isset($_GET['category_name'])){
                    ...
                    // echo $category;        
                        ...
                        <div class="each-products">                
                            <div class="product-image-container">
                                <img src="admin/uploads/<?php echo $array['picture'] ?>" alt="<?php echo $array['p_name'] ?>">
                            </div>
                            <div class="product-info">
        ...
        function recent_activity(){
                ...
                $id = $_SESSION['user_id'];
                    ...
                    $select2 = "SELECT * FROM recent_activity where user_id = '$id' ";
                    $qry2 = mysqli_query($conn, $select2);
                    
                    // print_r($fetch);
                    
                    while($fetch = mysqli_fetch_assoc($qry2)){
                    ...
                    <div class="activity-item">
                        ...
                        <div class="activity-content">
                            <div class="activity-text"><?php echo $fetch['activity'];?> </div>
                            <div class="activity-time"><?php echo $fetch['time'] ;?></div>
                        </div>
                    </div>
