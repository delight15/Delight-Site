...
if(isset($_POST['button'])){
    ...
    if(count($errors) === 0) {
        ...
        if(mysqli_num_rows($check_result) > 0) {
            ...
            $insert = "INSERT INTO users (firstname, lastname, email, region, phone, password) VALUES ('$firstname', '$lastname', '$email', '$region', $phonenumber, '$password' )";
    ...
    <div class="signup-container">
        <?php if($success): ?>
            ...
            <div class="success-message">
                ...
                <button class="btn-success" onclick="window.location.href='login.php'">
            ...
            <form action="" method="POST" class="signup-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="firstname" name="firstname" placeholder="John" value="<?php echo isset($_POST['firstname']) ? htmlspecialchars($_POST['firstname']) : ''; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="lastname"><i class="fa fa-user"></i> Last Name</label>
                        <input type="text" id="lastname" name="lastname" placeholder="Doe" value="<?php echo isset($_POST['lastname']) ? htmlspecialchars($_POST['lastname']) : ''; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="countries" name="countries" onchange="handlecountry()" required>
                ...
                <div class="form-group">
                    ...
                    <div class="phone-group">
                        ...
                        <input type="text" placeholder="Enter phone number" name="phone_number" value="<?php echo isset($_POST['phone_number']) ? htmlspecialchars($_POST['phone_number']) : ''; ?>" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="password-container">
                        ...
                        <i class="fa fa-eye-slash" id="toggleConfirmPassword" onclick="togglePasswordVisibility('confirm_password', 'toggleConfirmPassword')"></i>
                    </div>
                </div>
